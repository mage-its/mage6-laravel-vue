...
<div class="row">
<div class="col-lg-6">
<form id="form-utama" method="POST" enctype="multipart/form-data" action="/submitolim">
    @csrf
    @if ($data !== null)
    <input type="hidden" value="{{$data->id}}" name="id" />
    @endif
    <input type="hidden" value="olim" name="type" />
    <div id="main-form">
        <h3><b>Asal</b></h3>
        <section>
            <div class="form-group">
                <label for="asalSekolah">Asal Sekolah</label>
                <input oninput="this.value = this.value.toUpperCase()" type="text" id="asal"
                    value="{{$data->asal_sekolah ?? ""}}" required class="upper form-control" name="asal_sekolah"
                    aria-describedby="emailHelp" placeholder="Asal Sekolah...">
            </div>
            <div class="form-group">
                <label for="alamatSekolah">Alamat Sekolah</label>
                <input oninput="this.value = this.value.toUpperCase()" type="text" value="{{$data->asal_alamat ?? ""}}"
                    required class="upper form-control" name="asal_alamat" placeholder="Alamat Sekolah...">
            </div>
            <div class="form-group">
        ...
        <section>
            <div class="form-group">
                ...
                <input type="text" value="{{$data->nama_tim ?? ""}}" required class="form-control upper "
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{$data->nama_ketua ?? ""}}" required class="form-control upper "
            ...
            <div class="form-group ">
                ...
                <input type="text" class=" upper form-control" oninput="this.value = this.value.toUpperCase()"
                    value="{{$data->nama_anggota1 ?? ""}}" name="nama_anggota1" placeholder="Nama Anggota 1...">
            </div>
            <div class="form-group ">
                <label>Nama Anggota 2</label>
                <input type="text" class="upper form-control" oninput="this.value = this.value.toUpperCase()"
                    value="{{$data->nama_anggota2 ?? ""}}" name="nama_anggota2" placeholder="Nama Anggota 2...">
            </div>
        </section>
        ...
        <section>
            ...
            <div class="form-group ">
                ...
                @endif
                <input type="file" class="form-control-file" @if (!isset($data->path_ktpanggota1)) @endif
            ...
            <div class="form-group ">
                ...
                @endif
                <input type="file" class="form-control-file" @if (!isset($data->path_ktpanggota2)) @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ol>
                        ...
                        <li>Apabila dikemudian hari ditemukan bahwa dokumen yang telah kami berikan adalah tidak
                            benar,
                            maka kami bersedia dikenakan sanksi sesuai peraturan dan ketentuan yang berlaku </li>
                        <li>Formulir ini diisi tanpa adanya paksaan dari pihak manapun dan untuk digunakan
                            sebagaimana
                            mestinya </li>
