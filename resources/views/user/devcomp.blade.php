...
<div class="row">
    <div class="col-lg-6">
    <form id="form-utama" method="POST" enctype="multipart/form-data" action="/submitdevcom">
        @csrf
        @if ($data !== null)
        ...
        <div id="main-form">
            ...
            <section>
                ...
                <div class="form-group" id="jenjanglomba">
            ...
            <h3><b>Asal</b></h3>
            <section>
                <div class="form-group" id="asalsekolah">
                    <label for="asalSekolah">Asal Perguruan Tinggi / Sekolah</label>
                    <input id="asalSekolah" oninput="this.value = this.value.toUpperCase()" type="text" id="asal" value="{{$data->asal_perguruan ?? ""}}" required class="upper form-control" name="asal_perguruan" aria-describedby="emailHelp" placeholder="Asal Perguruan Tinggi...">
                </div>
                <div class="form-group" id="alamatsekolah">
                    <label for="alamatSekolah">Alamat Sekolah</label>
                    <input id="alamatSekolah" oninput="this.value = this.value.toUpperCase()"type="text" value="{{$data->asal_alamat ?? ""}}" required class="upper form-control" name="asal_alamat" placeholder="Alamat Sekolah...">
                </div>
                <div class="form-group">
            ...
            <section>
                <div class="form-group ">
                    @if (!isset($data->path_ktpketua))
                        <label>Scan Kartu Identitas Ketua (wajib)</label>
                    @else
                        <label>Scan Kartu Identitas Ketua <b class="text-success">Data Sudah Diupload</b> </label>
                    @endif
                    ...
                    <small class="form-text text-muted">
                        Dapat berupa Kartu Pelajar, Kartu Tanda Mahasiswa, KTP, maupun SIM.
                    </small>
                </div>
                <div class="form-group ">
                    @if (!isset($data->path_ktpanggota1))
                        <label>Scan Kartu Identitas Anggota 1 (wajib)</label>
                    @else
                        <label>Scan Kartu Identitas Anggota 1 <b class="text-success">Data Sudah Diupload</b> </label>
                    @endif
                ...
                <div class="form-group ">
                    @if (!isset($data->path_ktpanggota2))
                        <label>Scan Kartu Identitas Anggota 2 (wajib)</label>
                    @else
                        <label>Scan Kartu Identitas Anggota 2 <b class="text-success">Data Sudah Diupload</b> </label>
                    @endif
